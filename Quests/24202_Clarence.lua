...
if (EVENT == 700) then -- 45 Level Cardinal Jewel
	SelectMsg(UID, 2, 318, 1143, NPC, 28, 701);
end
...
-- [AUTO-GEN] quest=786 status=2 n_index=13784
if (EVENT == 101) then
...
-- [AUTO-GEN] quest=331 status=255 n_index=3231
if (EVENT == 300) then
	SaveEvent(UID, 3232);
end

-- [AUTO-GEN] quest=517 status=255 n_index=11033
if (EVENT == 3000) then
	SaveEvent(UID, 11034);
end

-- [AUTO-GEN] quest=518 status=255 n_index=11060
if (EVENT == 3100) then
	SaveEvent(UID, 11061);
end
