...
if (EVENT == 100)then
	QuestStatus = GetQuestStatus(UID, 721)	 
...
if(EVENT == 102) then
	...
	ZONE = GetZoneID(UID);
		if(ZONE == 1) then
			SpawnEventSystem(UID,9098,0,1,1499,0,1186);
			ShowEffect(UID, 300391)
			RobItem(UID, 900242000, 1);
		elseif(ZONE == 5) then
			SpawnEventSystem(UID,9098,0,5,1499,0,1186);
			ShowEffect(UID, 300391)
			RobItem(UID, 900242000, 1);
		elseif(ZONE == 6) then
			SpawnEventSystem(UID,9098,0,6,1499,0,1186);
			ShowEffect(UID, 300391)
			RobItem(UID, 900242000, 1);
		else
			SelectMsg(UID, 2, -1, 22279, NPC,10,-1);
