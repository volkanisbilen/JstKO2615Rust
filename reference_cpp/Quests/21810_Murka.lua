...
if (EVENT == 4000) then
	...
	if (Class == 4 or Class == 11 or Class == 12) then
		...
		if (SkillPoint > 59) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4000, 4007, 4001, 4010, 4002, 4013, 4003, 4016, 47, 4002);
		elseif (SkillPoint > 49) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4000, 4007, 4001, 4010, 4002, 4013, 47, 4002);
		elseif (SkillPoint > 39) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4000, 4007, 4001, 4010, 47, 4002);
		elseif (SkillPoint > 29) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4000, 4007, 47, 4002);
		else  
			SelectMsg(UID, 2, -1, 4143, NPC, 10, 4002);
		end
	else
		SelectMsg(UID, 2, -1, 4143, NPC, 10, 4002);
	end
...
if (EVENT == 4007) then
	...
	if (Check) then
		...
		if (min_count > 0) then
			...
			if (ItemA == 0 ) then
				SelectMsg(UID, 2, Savenum, 4148, NPC, 10, 4002);
			elseif (ItemB == 0 ) then
				SelectMsg(UID, 2, Savenum, 4149, NPC, 10, 4002);
			else
				SelectMsg(UID, 4, Savenum, 4146, NPC, 4004, 4008, 4005, 4002);
			end
		else
			SelectMsg(UID, 2, Savenum, 4147, NPC, 10, 4002);
		end
	else
		Ret = 1; 
	end  
	...
	if (Check) then
		...
		if (min_count > 0) then
			...
			elseif (ItemB == 0 ) then
				...
				SelectMsg(UID, 4, Savenum, 4146, NPC, 4004, 4011, 4005, 4002);
			end
		else
			SelectMsg(UID, 2, Savenum, 4147, NPC, 10, 4002);
		end
	...
	if (Check) then
		...
		if (min_count > 0) then
			...
			elseif (ItemB == 0 ) then
				...
				SelectMsg(UID, 4, Savenum, 4146, NPC, 4004, 4014, 4005, 4002);
			end
		else
			SelectMsg(UID, 2, Savenum, 4147, NPC, 10, 4002);
		end
	...
	if (Check) then
		...
		if (min_count > 0) then
			...
			elseif (ItemB == 0 ) then
				...
				SelectMsg(UID, 4, Savenum, 4146, NPC, 4004, 4017, 4005, 4002);
			end
		else
			SelectMsg(UID, 2, Savenum, 4147, NPC, 10, 4002);
		end
