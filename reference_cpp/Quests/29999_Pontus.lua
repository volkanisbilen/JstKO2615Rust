...
-----------------------------------// 1.Ana Menü	//-----------------------------------
if (EVENT == 100) then	
	SelectMsg(UID, 2, -1, 4131, NPC,45432, 200, 45433, 400,45486, 860,8975, 1300, 8976, 1310, 4479, 1200); 
end
-----------------------------------// 2.Ana Menü	//-----------------------------------
if (EVENT == 101) then  
	SelectMsg(UID, 2, -1, 4131, NPC, 2002, 102);   
end
-----------------------------------// 3.Ana Menü	//-----------------------------------
if (EVENT == 102) then  
	SelectMsg(UID, 2, -1, 4131, NPC,  2003, 101);   
end
...
if (EVENT == 200) then -- Change ID Menu
	SelectMsg(UID, 3, -1, 4131, NPC, 45439, 202, 45209, 203, 4296, 100);
end
...
if (EVENT == 400) then--7803,404,10005,405,8574,406, -- Premium Menu
	SelectMsg(UID, 3, -1, 45238, NPC,45241, 480, 4296, 100);
end
...
if (EVENT == 409) then
	...
	if (DCPREM < 1 or DCPREM == 0) then
     ...
     if SlotCheck == false then
		...
		GiveItem(UID, 800078000, 1); -- 1500 HP+ Scroll(L)
		GiveItem(UID, 800010000, 1); -- 300 Defense+ Scroll(L)
		GiveItem(UID, 800014000, 1); -- Scroll of Attack
		GiveItem(UID, 800015000, 1); -- Speed-Up Potion
