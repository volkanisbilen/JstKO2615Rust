...
if EVENT == 190 then
   ...
   if QuestNum == 0 then
      SelectMsg(UID, 2, -1, 3000, NPC, 10, -1);
...
if EVENT == 201 then
   SelectMsg(UID, 4, 319, 3141, NPC, 22, 202, 23, -1);
end
...
if EVENT == 210 then
   ...
   elseif ITEM_COUNT  > 0 then
      SelectMsg(UID, 4, 319, 3146, NPC, 10, 214, 27, -1);
   end
end
...
if EVENT == 214 then
	QuestStatusCheck = GetQuestStatus(UID, 319) 
