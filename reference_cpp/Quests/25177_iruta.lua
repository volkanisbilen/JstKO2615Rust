...
if (EVENT == 938) then -- Vip Hazır Paket Menüsü
	...
	if (VIPPackage < 1 or VIPPackage == 0) then
		SelectMsg(UID, 2, -1, 45037, NPC, 18, 5000);
	else
    EVENT = 939
	end
end
...
if (EVENT == 940) then -- Farm Hazır Paket Menüsü
	...
	if (FARMPackage < 1 or FARMPackage == 0) then
		SelectMsg(UID, 2, -1, 45050, NPC, 18, 5000);
	else
    EVENT = 941
	end
end
...
if (EVENT == 942) then -- PK Hazır Paket Menüsü
	...
	if (PKPackage < 1 or PKPackage == 0) then
		SelectMsg(UID, 2, -1, 45051, NPC, 18, 5000);
	else
    EVENT = 943
	end
end
...
-------------------------------------------------------------------------------------
if (EVENT == 944) then
	SelectMsg(UID, 3, -1, 11804, NPC,50520,944);
end
...
if (EVENT == 2005) then  --War Tattoo
	SelectMsg(UID, 3, -1, 11804, NPC,50572,7001,50573,7002,50574,7003,50575,7004,50576,7005);
end
...
if (EVENT == 6005) then -- War Tattoo 30 Günlük
