...
public:
	...
	uint16 GetYear() { return (uint16)(_tm->tm_year + 1900); }
	uint8 GetMonth() { return (uint8)(_tm->tm_mon + 1); }
	uint8 GetDay() { return (uint8)(_tm->tm_mday); }
	uint8 GetDayOfWeek() { return (uint8)(_tm->tm_wday); }
	uint8 GetHour() { return (uint8)(_tm->tm_hour); }
	uint8 GetMinute() { return (uint8)(_tm->tm_min); }
	uint8 GetSecond() { return (uint8)(_tm->tm_sec); }
