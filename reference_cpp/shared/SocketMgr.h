...
public:
	...
	void SpawnWorkerThreads(uint16 myPort, bool MultiT);
	...
	virtual Socket* AssignSocket(SOCKET socket, sockaddr_in m_tempAddress) = 0;
	...
	int m_threadCount, m_threadPort;
	static std::recursive_mutex s_disconnectionQueueLock;
	static std::vector<Socket*> s_disconnectionQueue;
