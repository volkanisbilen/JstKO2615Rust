...
public:
	...
	virtual tstring GetColumns() { return _T("iNum, DirectType, FirstDamage, TimeDamage, Duration, Attribute, Radius, AddDmgPercToUser, AddDmgPercToNpc"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchUInt16(8, pData->iADPtoUser);
		_dbCommand->FetchUInt16(9, pData->iADPtoNPC);
