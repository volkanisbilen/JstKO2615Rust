...
public:
	...
	virtual tstring GetTableName() { return _T("RIGHT_CLICK_EXCHANGE2369"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("RIGHT_CLICK_EXCHANGE1098"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("RIGHT_CLICK_EXCHANGE1534"); }
#endif
