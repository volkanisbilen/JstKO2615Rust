...
public:
	...
	virtual tstring GetColumns() { return _T("nIndex, nNPCNum, nOriginType, nOriginItem, "
		...
		"nReqNoah, bRateType, nGenRate, nTrinaRate, nKarivdisRate, nGiveItem"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchUInt32(i++, pData->sOriginItem);
		...
		_dbCommand->FetchUInt16(i++, pData->sTrinaRate);
		_dbCommand->FetchUInt16(i++, pData->sKarivdisRate);
