...
public:
	...
	virtual tstring GetColumns() { return _T("sMainAllianceKnights, sSubAllianceKnights, sMercenaryClan_1, sMercenaryClan_2, strAllianceNotice"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchString(5, pData->strAllianceNotice);
