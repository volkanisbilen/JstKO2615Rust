...
public:
	...
	virtual bool Fetch()
	{
		...
		if (byNation != (uint8)Nation::KARUS && byNation != (uint8)Nation::ELMORAD)
			return true;
		...
		_dbCommand->FetchUInt16(i++, pData->m_sKingClanID);
