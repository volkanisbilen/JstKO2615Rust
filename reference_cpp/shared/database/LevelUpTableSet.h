...
public:
	...
	virtual tstring GetTableName() { return _T("LEVEL_UP2369"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("LEVEL_UP1098"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("LEVEL_UP1534"); }
#endif
