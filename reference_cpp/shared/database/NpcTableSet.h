...
public:
	...
	virtual tstring GetTableName() { return _T("K_NPC2369"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("K_NPC1098"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("K_NPC1534"); }
#endif
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchUInt32(i++, pData->m_MaxHP);
		_dbCommand->FetchUInt16(i++, pData->m_MaxMP);
		...
		_dbCommand->FetchSingle(i++, pData->m_area_range);
...
#if GAME_SOURCE_VERSION  == 2369
	virtual tstring GetTableName() { return _T("K_MONSTER2369"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("K_MONSTER1098"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("K_MONSTER1534"); }
#endif
};