...
public:
	...
	virtual tstring GetColumns() { return _T("iNum, HitType, HitRate, AddDamage, AddRange, NeedArrow, AddDmgPercToUser, AddDmgPercToNpc"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchUInt16(7, pData->iADPtoUser);
		_dbCommand->FetchUInt16(8, pData->iADPtoNPC);
