...
public:
	...
	virtual tstring GetTableName() { return _T("K_OBJECTPOS2369"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("K_OBJECTPOS1098"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("K_OBJECTPOS1534"); }
#endif
