...
#define WIZ_CLAN_BATTLE			0x63 // Clan Battle
#define WIZ_QUEST				0x64
#define WIZ_PP_CARD_LOGIN		0x65 // akın
...
#define WIZ_ITEM_EXPIRATION		0x74 //s�reli item
...
#define WIZ_AKARA				0xC3	// Akara
#define WIZ_NOTICE_SEND			0xC4
#define WIZ_CLANWAREHOUSE		0xD1 // Clan Warehouse Open, In, Out

// 1. Terrain: Hay- Boosts Fire Magic,but weakens ıce and lightning damage.
// 2. Terrain: Swamp- Boosts all magic damage but decreases character speed.
// 3. Terrain: Water- Weakens Fire magic but boosts ıce and lightning damage.
// 4. Terrain: Swamp- Decreases character speed.
...
//
#define WIZ_VANGUARD			0xB6	//0xB6
#define WIZ_PRESET				0xB9
#define WIZ_KNIGHT_ROYALE		0xEF	//0xB7
#define WIZ_PARTY_HP			0xE8	//17.12.2020 Partyde HP Degeri Yazi Olarak Gosterme
#define WIZ_CAPTCHA				0xC0	//New System Captcha
#define WIZ_DAILYRANK			0xC2	//Daily Rank
...
#define CLAN_BANK_DB_SAVE 0x45
#define USER_LOOT_SETTINGS_DB_SAVE 0x46
#define USER_REPORT_DB_SAVE 0x47

#define LOGIN_LOGIN_CONNECT 0x01
#define LOGIN_ADD_ACCOUNT 0x02
#define LOGIN_REMOVE_ACCOUNT 0x03

enum RightClickExchangeSubcode
{
	GetItemList,
	GetCurrentItemList,
	GetExchangeMessage,
...
// this are used by databasethread
...
enum class PremiumPropertyOpCodes
{
...
#define PARTY_TARGET_NUMBER		0x1F	// 
#define PARTY_ALERT				0x20	// 
#define PARTY_COMMAND_PROMATE	0x1E	// 
...
enum MerchantOpcodes
{
	...
	MERCHANT_LIST				= 0x31,//2370 Merchant list paket void
	//MERCHANT_EYE				= 0x32//2370 Merchant list paket void

};

enum NameAndClanChangeSystemOpcode
{
	CharNameChange = 0,
	CharSelectNameChange = 2,
	ClanNameChange = 16
};

enum NameChangeErrorOpcode
{
...
enum ClanNameChangeErrorOpcode
{
	ShowDialog = 1,
	InvalidName = 2,
	NotClan = 4,
...
enum class ServerUniteSelectingCharNameErrorOpcode
{
	CannotCharacterID = 0,
	CharacterIDSuccesfull = 1
};

enum CharacterSelectingOpcode
{
	CannotSelectingCharacter = 0,
	Succesful = 1,
	AccountBlocked = 2,
	AlreadyCharacterName = 3,
	PrisonCharacter = 4,
	MaintanenceMode = 5
};
...
#define UPGRADE_DELAY			2 // seconds //30.08.2020 Seri Upgrade Fix
#define MINING_DELAY (5 * SECOND)
...
enum class e_SkillMagicFailMsg 
{
...
////////////////////////////////////////////////////////////////
enum class KnightsPacket
{
	KNIGHTS_CREATE			= 1, // clan creation
	KNIGHTS_JOIN			= 2, // joining a clan
	KNIGHTS_WITHDRAW		= 3, // leaving a clan
	KNIGHTS_REMOVE			= 4,	// removing a clan member
	KNIGHTS_DESTROY			= 5, // disbanding a clan
	KNIGHTS_ADMIT			= 6,
	KNIGHTS_REJECT			= 7,
	KNIGHTS_PUNISH			= 8,
	KNIGHTS_CHIEF			= 9,
	...
	KNIGHTS_MEMBER_REQ		= 13, // clan members listing
	KNIGHTS_CURRENT_REQ		= 14,
	KNIGHTS_STASH			= 15,
	KNIGHTS_MODIFY_FAME		= 16,
	KNIGHTS_JOIN_REQ		= 17,
	KNIGHTS_LIST_REQ		= 18,

	KNIGHTS_WAR_ANSWER		= 20,
	KNIGHTS_WAR_SURRENDER	= 21,

	KNIGHTS_MARK_VERSION_REQ= 25,
	KNIGHTS_MARK_REGISTER	= 26,
	KNIGHTS_CAPE_NPC		= 27,
	KNIGHTS_ALLY_CREATE		= 28,
	KNIGHTS_ALLY_REQ		= 29,
	KNIGHTS_ALLY_INSERT		= 30,
	...
	KNIGHTS_MARK_REQ		= 35,
	KNIGHTS_UPDATE			= 36,
	KNIGHTS_MARK_REGION_REQ	= 37,

	KNIGHTS_USER_ONLINE     = 39,
	KNIGHTS_USER_OFFLINE    = 40,

	KNIGHTS_UPDATE_GRADE	= 48,
...
#if __VERSION > 2100
	KNIGHTS_VS_LIST			= 96,
	KNIGHTS_CLAN_BONUS		= 98,
	KNIGHTS_UNK1			= 99,
	KNIGHTS_LADDER_POINTS   = 100,
#endif
	// These are NOT official client opcodes.
	// They are opcodes for the database thread only.
	KNIGHTS_REFUND_POINTS	= 240,
	KNIGHTS_UPDATE_FUND		= 241,
	KNIGHTS_UPDATE_USER		= 242,
	KNIGHTS_UPDATE_CAPE		= 243,
};

enum class KingCapeType
{
	KNIGHTS_KARUS_KING_CAPE = 97,
	KNIGHTS_HUMAN_KING_CAPE = 98,
	KNIGHTS_KNIG_CAPE = 99,
};
...
enum class DailyOperationsOpCode
{
	DAILY_CHAOS_MAP						= 1,
...
// ClanBank OpCodes
////////////////////////////////////////////////////////////////
enum ClanBankOpcodes
{
	ClanBankOpen = 0x01,
	ClanBankInput = 0x02,
	ClanBankOutPut = 0x03,
	ClanBankMove = 0x04,
	ClanBankInventoryMove = 0x05
};
...
#define PROMOTE_NOVICE			0x06
#define REB_STAT_CHANGE			0x07
#define REB_STAT_RESET			0x08
...
enum TempleOpCodes
{
	...
	TEMPLE_EVENT_GET_EXP         = 11, //Xtreme Monster Stone Recive Exp vermesi
...
enum ItemUpgradeOpcodes
{
	...
	PET_HATCHING_TRANSFROM	= 6,
	ITEM_UPGRADE_REBIRTH	= 7,
	ITEM_SEAL				= 8,
	ITEM_CHARACTER_SEAL		= 9,
	PET_IMAGE_TRANSFORM		= 10,
	SPECIAL_PART_SEWING		= 11,
	UNKNOWN_PACKET			= 12,
	ITEM_OLDMAN_EXCHANGE	= 13,
	ITEM_UPGRADE_REBIRTH_TO_HIGHT = 14
};
...
enum class UpgradeScrollType
{
	...
	ClassScroll = 5, //ClassScroll 6 to 7 %100
	HighToRebirthScroll = 15,
	RebirthToHighScroll = 16,
...
#define PARTY_TYPE_SEEKING 0x00
#define PARTY_TYPE_DUNGEON_DEFENCE 0x02
////////////////////////////////////////////////////////////////
...
#define PARTY_BBS_PARTY_CHANGE  0x05
#define PARTY_BBS_PARTY_DELETE	0x06
...
#define WIZ_REMOVE_CURRENT_USER	0xFD	// define for DBAgent Communication
////////////////////////////////////////////////////////////////
...
enum class LetterOpcodes
{
	...
	LETTER_DELETE		= 7,
	LETTER_ITEM_CHECK	= 8, // ???
	LETTER_GIVE_PRE_ITEM = 9,
	LETTER_GIVE_BEGINNER_ITEM = 10	// this is used by server only
};
