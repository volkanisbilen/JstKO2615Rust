...
public:
	...
	void Disconnect(bool socketdisconnect = false);
...
public:
	const bool IsOffCharacter() const { return m_offchstatus == _choffstatus::ACTIVE; }
	void SetOffCharacter(const _choffstatus val) { m_offchstatus = val; }
...
public:
	_choffstatus m_offchstatus = { _choffstatus::DEACTIVE };
};
