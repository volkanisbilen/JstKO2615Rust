...
template <> INLINE int lua_to<int>(lua_State * L, int idx) { return (int) luaL_checkinteger(L, idx); }
template <> INLINE short lua_to<short>(lua_State * L, int idx) { return (short) luaL_checkinteger(L, idx); }
template <> INLINE char lua_to<char>(lua_State * L, int idx) { return (char) luaL_checkinteger(L, idx); }
...
template <> INLINE int lua_to_default<int>(lua_State * L, int idx, int def) { return (int) luaL_optinteger(L, idx, def); }
template <> INLINE short lua_to_default<short>(lua_State * L, int idx, short def) { return (short) luaL_optinteger(L, idx, def); }
template <> INLINE char lua_to_default<char>(lua_State * L, int idx, char def) { return (char) luaL_optinteger(L, idx, def); }
