...
LUA_FUNCTION(RunRandomExchange);
...
LUA_FUNCTION(SendTagNameChangePanel);
...
LUA_FUNCTION(GiveSwitchPremium); //17.12.2020 Switch Premium Yukler Yuklemez 3 n birden goruntuluyecek sekilde yeni komut eklendi
...
LUA_FUNCTION(SendNpcKillID); //npckill
LUA_FUNCTION(CheckBeefEventLogin);
LUA_FUNCTION(CheckCash);
LUA_FUNCTION(GenieExchange);
LUA_FUNCTION(ClanNts);
LUA_FUNCTION(PerkUseItem);
