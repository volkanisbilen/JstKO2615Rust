...
#define CONF_EVENT_SETTINGS "./EventSettings.ini"
#define CONF_COLLECTION_RACE	"./CollectionRace.ini"
#define CONF_EVENT_AWARDS	"./EventAwards.ini"
#define CONF_DEAFSOFT	"./JstKOSettings.ini" // JstKO Files Defter Ayarlar Eklendi 01.01.2025
...
#define KARUS_ARRAY ((uint8)Nation::KARUS - 1)
#define ELMORAD_ARRAY ((uint8)Nation::ELMORAD - 1)
...
//1098 AND 2369
#define GAME_SOURCE_VERSION 2369	// 1098 Myko Or 2369 v2 Server and 1534.
#define LISANS_SYSTEM 0  //DeaFSezo Lisans System A��p Kapatma Ekledim 28.12.2024
...
#define ZONE_SPBATTLE12			ZONE_SPBATTLE_BASE +12
...
#define RELOAD_GAME_UPDATE 120 // Secound
...
#define RANGE_15M (15.0f * 15.0f) // DeaFSezo warrior skill vurma fix 28.12.2024
#define RANGE_20M (20.0f * 20.0f)
#define RANGE_30M (30.0f * 30.0f)
// Standard (pre-squared) range used for party rewards and such.
#define RANGE_50M (50.0f * 50.0f)
#define RANGE_60M (60.0f * 60.0f)
#define RANGE_70M (70.0f * 70.0f)
#define RANGE_80M (80.0f * 80.0f)
#define RANGE_100M (100.0f * 100.0f)
#define RANGE_200M (200.0f * 200.0f)
...
#define ITEM_JOB_CHANGE			700112000 
#define ITEM_JOB_CHANGE2		700113000 
...
#define ITEM_CLAN_PREMIUM		399300914   // Clan Premium Kodu
#define OFFLINE_MERCHANT_ITEM	924041913 //Offline Merchant Kodu
...
#define AUTOMATIC_UPGRADE			544000000

#define MINING_ROBIN_ITEM		510000000
#define FISHING_ROBIN_ITEM		520000000
...
#define CLAN_MONUMENT_SPID		        29516  
...
#define CLANK_BANK_NPC_SSID			19999
...
struct AutoUpItemx
{
	...
	AutoUpItemx(uint32 ItemID, uint8 sPos)
	{
		nItemID = ItemID;
		sPosition = sPos;
	}
...
#define TO_BOT(v)	static_cast<CBot *>(v)
