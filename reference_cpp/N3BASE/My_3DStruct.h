...
/**
* @brief	Normalized vector is the same vector with the unit
*			length(1).  
*/
...
/**
* @brief	In mathematics, the dot product, or scalar product 
...
/**
* @brief	In mathematics, the cross product or vector product is a binary 
*			operation on two vectors in three-dimensional space and is denoted 
*			by the symbol ×. The cross product a × b of two linearly independent 
*			vectors a and b is a vector that is perpendicular to both and 
